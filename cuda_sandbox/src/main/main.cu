...
// Save rotation matrices at each cheb point
// cublas<t>gemvStridedBatched()

// 1) Check how the data is stored in the GPU
// 2) Check how to use the cublas<t>gemvStridedBatched() function
// 3) Test on Dummy code cublas<t>gemvStridedBatched() function
...
{   
    ...
    // TODO : COMPUTE ALL OF RES IN ONE GO
